...
class EraserDisplay extends StatefulWidget {
...
class _TouchIndicatorState extends State<EraserDisplay> {
  ...
  Iterable<Widget> buildTouchIndicators() sync* {
    if (touchPositions.isNotEmpty) {
      for (var touchPosition in touchPositions.values) {
        ...
        //debugPrint("DEBUG_LOG TOUCHPOSITION, X:" + touchPosition.dx.toString() + " Y:" + touchPosition.dy.toString());
        //debugPrint("DEBUG_LOG SCROLLOFFSET, VALUE:" + widget.scrollOffset.toString());

        yield Positioned.directional(
          start: touchPosition.dx - 25, //- widget.indicatorSize / 2,
          top: touchPosition.dy - 250 + widget.scrollOffset, //- widget.indicatorSize / 2,
          ...
          child: widget.indicator != null
            ...
            child: Image.asset("images/eraser.png",width:50,),

            /*Icon(
              Icons.fingerprint,
              size: widget.indicatorSize,
              color: Colors.redAccent,//.indicatorColor.withOpacity(0.9),
            ),*/
          ),
        );
      }
